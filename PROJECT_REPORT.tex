...
\begin{figure}[htbp]
\centering
% \includegraphics[width=0.45\textwidth]{dashboard_main} 
\caption{Interactive Climate Analytics Dashboard Main View}
\label{fig:dashboard}
\end{figure}
...
\begin{figure}[htbp]
\centering
% \includegraphics[width=0.45\textwidth]{cluster_plot} 
\caption{K-Means Cluster Centroids (Placeholder for Screenshot)}
\label{fig:kmeans}
\end{figure}
