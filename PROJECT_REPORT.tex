...
\begin{IEEEkeywords}
Data Engineering, ETL, Machine Learning, Polyglot Persistence, Environmental Kuznets Curve, Sustainability.
\end{IEEEkeywords}
...
\begin{figure}[htbp]
\centering
% \includegraphics[width=0.45\textwidth]{architecture_diagram} 
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.45\textwidth]{docs/images/trend_energy_use.png} 
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.45\textwidth]{docs/images/correlation_heatmap.png} 
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.45\textwidth]{docs/images/kmeans_clusters.png} 
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.45\textwidth]{docs/images/feature_importance.png} 
